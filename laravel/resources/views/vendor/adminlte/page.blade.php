                    ...
                    <ul class="nav navbar-nav">
                      ...
                      <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img class="foto_perfil img-circle" onerror="this.src='{{ asset('img/user.png') }}'"  src="{{ asset('img/user/') }}/{{ hash('sha256',Auth::user()->id) }}.png" width="32px" height="32px" alt="{{ Auth::user()->name }}">
                            <span class="hidden-xs">{{ Auth::user()->name }}</span>
                        </a>
                        <ul class="dropdown-menu">
                          <!-- User image -->
                          <li class="user-header">
                            <img class="foto_perfil img-circle" onerror="this.src='{{ asset('img/user.png') }}'"  src="{{ asset('img/user/') }}/{{ hash('sha256',Auth::user()->id) }}.png" alt="{{ Auth::user()->name }}">
                            <p>                                
                                <small>
